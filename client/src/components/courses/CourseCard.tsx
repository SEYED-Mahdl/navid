...
export function CourseCard({ course }: CourseCardProps) {
  ...
  return (
    <div className="course-card">
      <Card className="bg-card transition group h-full flex flex-col overflow-hidden">
        ...
        <CardContent className="p-5 flex-grow flex flex-col">
          <Link href={`/courses/${course.id}`}>
            <h3 className="text-xl font-bold mb-3 hover:text-primary cursor-pointer transition-colors">{course.title}</h3>
          </Link>
          ...
          <div className="mt-auto flex gap-2">
            ...
            <Button className="w-full flex-1" size="sm" asChild>
