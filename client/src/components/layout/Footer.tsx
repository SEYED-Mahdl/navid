      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 space-x-reverse">
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition">
            ...
            <a href="mailto:contact@example.com" className="text-muted-foreground hover:text-primary transition">
        ...
        <div className="text-center mt-8 text-muted-foreground text-sm">
          تمامی حقوق این وب‌سایت متعلق به آکادمی دکتر نوید کلانی می‌باشد. &copy; ۱۴۰۲
        </div>
      </div>
    </footer>
  );
